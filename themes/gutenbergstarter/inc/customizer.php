...
function options_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'header_section', array(
		...
		$wp_customize->add_control( 'header_background_opacity', array(
			...
			'type'    => 'text',
			'description' => __( 'Min:0, Max: 1. Example: 0.7', 'gutenbergtheme' ),
		));
		...
		$wp_customize->add_setting( 'header_dropdown_background', array(
			'default'     => '#FFFFFF',
			'sanitize_callback'	=> 'esc_attr',
		) );

		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_dropdown_background', array(
			'label'   => 'Header Dropdown Menu Background',
			'section' => 'header_section',
